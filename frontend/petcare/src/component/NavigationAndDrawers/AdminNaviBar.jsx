...
const AdminNaviBar = ({ isAdmin }) => {
    ...
    useEffect(() => {
        const fetchAdminNavData = async () => {
            try {
                const response = await axios.get('https://petcare-ycz3.onrender.com/admin_navigation');
    ...
    const fetchAuthStatus = async () => {
        try {
            const response = await axios.get('https://petcare-ycz3.onrender.com/auth/status', { withCredentials: true });
            setLoggedIn(true);
        } catch (error) {
    ...
    const handleLogout = async () => {
        try {
            await axios.get('https://petcare-ycz3.onrender.com/logout', { withCredentials: true });
            setLoggedIn(false);
